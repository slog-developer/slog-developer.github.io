<div class="gnb_section">
	<div class="logo">
		<a href="/index.php"><img src="/std/images/logo_sp/sp_logo_03.png" alt="logo" /></a>
	</div>
	<nav class="fs_gnb">
		<ul>
	...
	<div class="lojo_secetion">
		<div class="login_link">
			<ul class="login_lnb">
				...
				<?}else{?>
					<li class="coin_point"><a href="javascript:void(0);" class="purple_main"><i class="fas fa-coins"></i>포인트</a></li>
				<?}?>
			</ul>
		</div>	            
	</div>
